"""NC State job postings via their public Atom feed, filtered to Kannapolis-area content."""
...
FEED_URL = "https://jobs.ncsu.edu/postings/all_jobs.atom"
...
class NCStateScraper(BaseScraper):
    ...
    def fetch(self, keyword: str = "") -> list[Job]:
        ...
        print("  Fetching NC State Atom feed...")
